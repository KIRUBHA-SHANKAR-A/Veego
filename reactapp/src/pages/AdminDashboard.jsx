...
import { 
  Users, Package, CheckCircle, Clock, TrendingUp, 
   Shield, UserPlus, Building, Target, Sparkles, Award,
  BarChart3, Star, AlertTriangle, ArrowUpRight
} from 'lucide-react';
import { useScrollToTop } from '../hooks/useScrollToTop';
import { showSessionExpired } from '../components/SessionExpired';
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl shadow-2xl p-8 text-center max-w-md">
          ...
          <p className="text-gray-600">You need administrator privileges to access the dashboard.</p>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-indigo-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 mt-1">Admin Dashboard - Complete platform oversight.</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          >
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-white/80 text-sm mt-1">Review vendor applications</p>
              </div>
          ...
          >
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-white/80 text-sm mt-1">Review snack submissions</p>
              </div>
              <div className="text-center bg-white/20 rounded-xl p-3">
          ...
          <button
            onClick={() => navigate('/create-product-manager')}
            className="bg-gradient-to-r from-purple-500 to-pink-600 text-white p-6 rounded-2xl hover:shadow-xl transition-all duration-200 text-left group"
          >
            <div className="flex items-center justify-between">
              <div>
                <UserPlus className="h-8 w-8 mb-2 opacity-90" />
                <h3 className="text-xl font-bold">Create PM</h3>
                <p className="text-white/80 text-sm mt-1">Add product manager</p>
              </div>
              <div className="text-center bg-white/20 rounded-xl p-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-2xl p-6 border border-green-100">
            ...
            <p className="text-sm text-gray-600 mt-2">Successfully approved</p>
          </div>
